<div class="form-item">
    ...
    <?php echo form_input(array(
        'name' => 'meta[title]',
        'class'=> 'form-text',
        'value'=> set_value('meta[title]', $title),
    ));?>
    ...
    <?php echo form_input(array(
        'name' => 'meta[keywords]',
        'class'=> 'form-text',
        'value'=> set_value('meta[keywords]', $keywords),
    ));?>
    ...
    <?php echo form_textarea(array(
        ...
        'class'=> 'form-textarea',
        'rows' => '3',
        'value'=> set_value('meta[description]', $description),
    ));?>

    <?php echo form_hidden('meta_id', $meta_id); ?>
