...
<table><tbody><tr>
    ...
    <td class="left-col">
        ...
        <div class="form-item">
            ...
            <input type="text" name="article[title]" class="form-text" value="<?php echo set_value('page[title]') ?>"/>
        </div>
        ...
        <div class="form-item">
            ...
            <?php 
                echo Modules::run('resorts/dropdown', array(
                    ...
                    'value' => set_value('article[resort_id]', '')
                )); 
            ?>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="b-upload">
                ...
                <?php if (set_value('article[img]')) : ?>
                    <input type="hidden" class="js-tmp-src" value="<?php echo set_value('article[img]'); ?>" />
                <?php endif; ?>
                <div class="clear"></div>
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <label>
                <input type="checkbox" name="article[status]" value="1" <?php echo set_checkbox('article[status]', 1, TRUE); ?> />
                Опубликовано
            </label>
            <label>
                <input type="checkbox" name="article[sticky]" value="1" <?php echo set_checkbox('article[sticky]', 1); ?>/>
        ...
        <?php echo anchor('admin/article/list', 'Отмена'); ?>
    ...
    <td class="right-col">
        ...
        <div class="form-item">
            ...
            <?php $this->ckeditor->editor('article[body]', html_entity_decode(set_value('article[body]'))); ?>
        </div>
